...
namespace HeroRPGAssignment.HeroClasses
{
    ...
    {
        //Creates herotype Ranger
        public Ranger(string name) : base()
        {
            this.Name = name;
            this.HeroAttributes = new HeroAttributes(1, 7, 1);
            this.Herotype = HeroType.Ranger;
            this.HeroWeapons = new WeaponType[1] { WeaponType.Bow };
        ...
        //Levels heros level by +1 and heroAttributes up by Ranger attributes (1,5,1)
        public override void LevelUp()
        {
            Level++;
            HeroAttributes.Strength = HeroAttributes.Strength + 1;
            HeroAttributes.Dexterity = HeroAttributes.Dexterity + 5;
